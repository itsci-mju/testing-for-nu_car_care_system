...
public class Driver {
	...
	public String keyword_executor(String vKeyword, String vIP1, String vIP2) throws Exception {
		...
		public void getData(int k) {
			...
			StartUp.vProImage = StartUp.xTDdata[k][6];
			StartUp.vProname = StartUp.xTDdata[k][7];
			StartUp.vDetail = StartUp.xTDdata[k][8];
			StartUp.vPrice = StartUp.xTDdata[k][9];
			StartUp.vSD = StartUp.xTDdata[k][10];
			StartUp.vED = StartUp.xTDdata[k][11];
		}
	}
