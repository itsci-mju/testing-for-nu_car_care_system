...
public class StartUp {
	...
	/**/public static String vUrl, vSername, vDetail, vPrice;
	...
	public static void main(String[] args) throws Exception {
		...
		String xlPath_tc = "G://KDF_CarcareProject/TC09/TC_edit_service_TC09.xlsx";
		String xlPath_ts = "G://KDF_CarcareProject/TC09/TS_edit_service_TC09.xlsx";
		String xlPath_td = "G://KDF_CarcareProject/TC09/TD_edit_service_TC09.xlsx";
		String xlPath = "TC09-edit service.xlsx";
						...
						if (xTCdata[i][1].equals(xTSdata[j][0])){	
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if (vKeyword.equals("get_alert")) {
	                				xTSdata[j][8] = "Pass";
	                				if (vResult.equalsIgnoreCase(xTDdata[k][8])) {
	                					xTDdata[k][9] = "Pass";
	                				...
	                				if (expRe.equals("กรุณากรอกราคาให้ถูกต้อง/ราคาต้องมีเครื่องหมาย ( , ) คั่นระหว่างตัวเลข ")) { 
	                					xTDdata[k][11] = "ควรมีแจ้งเตือน Alert ให้ผู้ใช้กรอกเครื่องหมาย (,) ระหว่างตัวเลข";
	    	    					}
