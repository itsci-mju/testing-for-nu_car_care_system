...
public class StartUp {
	...
	/**/public static String vUrl, vProImage, vProname, vDetail, vPrice, vSD, vED;
	...
	public static void main(String[] args) throws Exception {
		...
		String xlPath_tc = "G://KDF_CarcareProject/TC04/TC_add_promotion_TC04.xlsx";
		String xlPath_ts = "G://KDF_CarcareProject/TC04/TS_add_promotion_TC04.xlsx";
		String xlPath_td = "G://KDF_CarcareProject/TC04/TD_add_promotion_TC04.xlsx";
		String xlPath = "TC04-add promotion.xlsx";
						...
						if (xTCdata[i][1].equals(xTSdata[j][0])){	
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if (vKeyword.equals("get_alert")) {
	                				xTSdata[j][8] = "Pass";
	                				if (vResult.equalsIgnoreCase(xTDdata[k][11])) {
	                					xTDdata[k][12] = "Pass";
		                				xTDdata[k][13] = "No Error";
		                				xTDdata[k][10] = vResult;
	    	                		}else {
	                					xTDdata[k][12] = "Fail";
		                				xTDdata[k][13] = "Not Match Expected Result";
		                				xTDdata[k][10] = vResult;
	                				...
	                				if (expRe.equals("กรุณากรอกราคาให้ถูกต้อง/ราคาต้องมีเครื่องหมาย ( , ) คั่นระหว่างตัวเลข ")) {   
	                					xTDdata[k][14] = "ควรมีแจ้งเตือน Alert ให้ผู้ใช้กรอกเครื่องหมาย (,) ระหว่างตัวเลข";
	    	    					} else if (expRe.equals("กรุณากรอกวันที่เริ่มต้นให้ถูกต้อง")) {      
		                				xTDdata[k][14] = "ควรมีการแจ้งรายละเอียดให้ผู้ใช้กรอกวันที่เริ่มต้นให้เป็นวันที่ในอนาคตเท่านั้น";
	    	    					} else if (expRe.equals("กรุณากรอกวันที่สิ้นสุดให้ถูกต้อง")) {      
		                				xTDdata[k][14] = "ควรมีการแจ้งรายละเอียดให้ผู้ใช้กรอกวันที่สิ้นสุดให้เป็นวันที่ในอนาคตเท่านั้น";
	    	    					}
