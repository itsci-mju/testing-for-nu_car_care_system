...
public class StartUp {
	...
	public static void main(String[] args) throws Exception {
		...
		String xlPath_tc = "G://KDF_CarcareProject/TC12/TC_delete_promotion_TC12.xlsx";
		String xlPath_ts = "G://KDF_CarcareProject/TC12/TS_delete_promotion_TC12.xlsx";
		String xlPath_td = "G://KDF_CarcareProject/TC12/TD_delete_promotion_TC12.xlsx";
		String xlPath = "TC12-delete promotion.xlsx";
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if (vKeyword.equals("get_alert")) {
	                				...
	                				if (vResult.equalsIgnoreCase(xTDdata[k][8])) {
		                				...
		                				xTDdata[k][7] = vResult;    
	    	                		}else if (expRe.equals("การลบข้อมูลสำเร็จ")) {
	                					xTDdata[k][9] = "Pass";
		                				xTDdata[k][10] = "No Error";	            
		                				xTDdata[k][7] = "การลบข้อมูลสำเร็จ";
	    	                		}else {
	                					xTDdata[k][9] = "Fail";
