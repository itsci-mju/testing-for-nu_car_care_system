...
public class Utility {
	...
	/*
	 * public String get_alert() { String text = ""; WebDriverWait wait = new
	 * WebDriverWait(webDriver, 10);
	 * wait.until(ExpectedConditions.alertIsPresent()); text =
	 * webDriver.switchTo().alert().getText(); return text; }
	 */
	  ...
	  public void saveScreen(String index) {
		 ...
		 try {
			FileUtils.copyFile(scrFile, new File("G://KDF_CarcareProject/IMG/TC01/x"+ index +".png"));
		} catch (IOException e) {
			e.printStackTrace();
		}   
	}
