...
public class Driver {
	...
	public String keyword_executor(String vKeyword, String vIP1, String vIP2) throws Exception {
		...
		public String getIP(String vIP){ 
			...
			if (vIP.equals("vSersize")){
				vIP = StartUp.vSersize;
			}
			if (vIP.equals("vSername")){
				vIP = StartUp.vSername;
			}
		...
		public void getData(int k) {
			...
			StartUp.vSersize = StartUp.xTDdata[k][4];
			StartUp.vSername = StartUp.xTDdata[k][5];
