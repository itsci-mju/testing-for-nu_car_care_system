...
public class StartUp {
	...
	/**/public static String vUrl, vSersize, vSername, vDetail, vPrice;
	...
	public static void main(String[] args) throws Exception {
		...
		String xlPath_tc = "G://KDF_CarcareProject/TC03/TC_add_service_TC03.xlsx";
		String xlPath_ts = "G://KDF_CarcareProject/TC03/TS_add_service_TC03.xlsx";
		String xlPath_td = "G://KDF_CarcareProject/TC03/TD_add_service_TC03.xlsx";
		String xlPath = "TC03-add service.xlsx";
						...
						if (xTCdata[i][1].equals(xTSdata[j][0])){	
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if (vKeyword.equals("get_alert")) {
	                				...
	                				if (vResult.equalsIgnoreCase(xTDdata[k][9])) {
	                					xTDdata[k][10] = "Pass";
		                				xTDdata[k][11] = "No Error";
		                				xTDdata[k][8] = vResult;
	    	                		}else {
	                					xTDdata[k][10] = "Fail";
		                				xTDdata[k][11] = "Not Match Expected Result";
		                				xTDdata[k][8] = vResult;
	                				...
	                				if (expRe.equals("กรุณากรอกราคาให้ถูกต้อง/ราคาต้องมีเครื่องหมาย ( , ) คั่นระหว่างตัวเลข ")) { 
	                					xTDdata[k][12] = "ควรมีแจ้งเตือน Alert ให้ผู้ใช้กรอกเครื่องหมาย (,) ระหว่างตัวเลข";
	    	    					}
