...
public class StartUp {
	...
	/**/public static String vUrl, vUserLogin, vPassLogin, vSearch, vOperation, vPayment;
	...
	public static void main(String[] args) throws Exception {
		...
		String xlPath_tc = "G://KDF_CarcareProject/TC08/TC_update_car_receipt_to_bill_TC08.xlsx";
		String xlPath_ts = "G://KDF_CarcareProject/TC08/TS_update_car_receipt_to_bill_TC08.xlsx";
		String xlPath_td = "G://KDF_CarcareProject/TC08/TD_update_car_receipt_to_bill_TC08.xlsx";
		String xlPath = "TC08-update car receipt to bill.xlsx";
	                		...
	                		if (vResult.equalsIgnoreCase("Pass")) {
	                			...
	                			if (vKeyword.equals("get_alert")) {
	                				...
	                				if (vResult.equalsIgnoreCase(xTDdata[k][10])) {
	                					xTDdata[k][11] = "Pass";
		                				xTDdata[k][12] = "No Error";
		                				xTDdata[k][9] = vResult;
	                				}else {
	                					xTDdata[k][11] = "Fail";
	                					xTDdata[k][12] = "Not Match Expected Result";
		                				xTDdata[k][9] = vResult;
