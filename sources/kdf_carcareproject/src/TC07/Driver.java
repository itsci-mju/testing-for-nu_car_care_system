...
public class Driver {
	...
	public String keyword_executor(String vKeyword, String vIP1, String vIP2) throws Exception {
		...
		public String getIP(String vIP){ 
			...
			if (vIP.equals("vService")){
				vIP = StartUp.vService;
			}
			if (vIP.equals("vPromotion")){
				vIP = StartUp.vPromotion;
			}
		...
		public void getData(int k) {
			...
			StartUp.vService = StartUp.xTDdata[k][7];
			StartUp.vPromotion = StartUp.xTDdata[k][8];
		}
	}
